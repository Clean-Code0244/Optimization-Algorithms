        ...
        for iteration in range(self.max_iter):
            for i in range(self.num_wolves):
                ...
                if fitness < alpha_fitness:
                    ...
                    print("Alpha positon :",alpha_position,"Fitness Alpha :",alpha_fitness)
                elif fitness < beta_fitness:
                    beta_fitness = fitness
                    beta_position = wolves_positions[i].copy()
                    print("Beta positon :",beta_position,"Fitness Beta :",beta_fitness)
                elif fitness < delta_fitness:
                    delta_fitness = fitness
                    delta_position = wolves_positions[i].copy()
                    print("Delta positon :",delta_position,"Fitness Delta :",delta_fitness)

            a = 2 - 2 * iteration / self.max_iter  # a lineer olarak 2'den 0'a azalır
...
def sphere_function(x):
    ...
    print("P1:",coordinates[0])
    print("P2:",coordinates[1])
    print("P3:",coordinates[2])
    print("P4:",coordinates[3])
    print("P5:",coordinates[4])
    print("**************************")
    return total
